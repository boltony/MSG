...
<div class=policyContainer>
	<div id=policyTitle1>
		...
		<div id=policy2>
			...
			<a href="#" class=poline onclick="window.open('${pageContext.request.contextPath}/member/emailCollect.jsp','policy',
			'width=850,height=430,location=no,status=no,scrollbars=no'); return false;">이메일 무단 수집 거부</a><br>
			<a href="#" class=poline onclick="window.open('${pageContext.request.contextPath}/member/inquiry.jsp','policy',
