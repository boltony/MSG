		...
		<div id=leftBar_contents2>
			...
			<c:choose>
				<c:when test="${list.size()==0}">
					<div
						style="width: 80%; height: 200px; line-height: 200px; text-align: center;">작성된
						글이 없습니다.</div>
				...
				<c:otherwise>
					<c:forEach var="dto" items="${pageList}">
						<div class=donationTb>
							...
							<a href="주소.bo?seq=${dto.seq}" id=dn_td2_a><div class="dn_td dn_td2">${dto.title}</div></a>
			...
			<div class=donationTop style="width: 85%; text-align: center;">
