...
<body>
   ...
   <div style="width: 100%; height: 1000px; position: relative; min-width:1400px;">
      ...
      <div style="min-width:182px;width: 300px; height: 100%;  float: left; padding-left: 30px; line-height: 20px;" class="col-2">
                ...
                <p style="text-align:center;font-size:20px;width:160px;height:30px;line-height:30px;background-color: #476491;"><a href="${pageContext.request.contextPath}/child/insertInfo.jsp" class=mya style="color:white">실종정보등록</a></p>
                ...
                <p style="text-align:center;font-size:20px;width:160px;height:30px;line-height:30px;"><a href="${pageContext.request.contextPath}/sos/em.jsp" class=mya>긴급메일작성</a></p>
            </div>
         ...
         <div id="maininsert" class="col-9"
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td colspan="3"><input type="radio" class="target"
                           ...
                           아동(만18세 미만) <input type="radio" class="target"
                     ...
                     <tr>
                        ...
                        <td colspan="3"><input type="text" name="missing_date"
                           ...
                           id="mistime" style="color: red">자세히 기억안나도 대략적인시간을 입력해주세요</label></td>
                     </tr>
                     <tr>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td colspan="5"><textarea id="feature" cols="70" rows="5"
                           ...
                           style="margin-bottom: -7px; resize:none"></textarea> <label id="feack"
            ...
            <div style="text-align: center; font-size: 20px;">
               ...
               <input type="button" class="bton" id="send" value="접수" /> <input
                  type="reset" class="bton" value="취소" />
            </div>
   ...
   <script>
    ...
    $("#birth_date").on("focusout",function(){   //나이검사(18세미만은 실종아동등록안되게)
       var birthdata = $("#birth_date").val();
       var date = new Date();
