		...
		<div class="row">
			...
			<div class="col-9">
				...
				<div class="row text-right" style="padding-top:20px; padding-right:62px;min-width:700px">
					<div class="col-12">
						<form action="${pageContext.request.contextPath}/missing.bo?board=M" method="post">
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<tr>
										...
										<td class="tTitle"><a href="${pageContext.request.contextPath}/detailView.bo?seq=${dto.seq }&currentPage=${currentPage}&board=M">${dto.title }</a>
...
<script>
	$("#writeBtn").on("click", function(){
		location.href="${pageContext.request.contextPath}/writejsp.bo?currentPage=${currentPage}&board=M";
	})
</script>
