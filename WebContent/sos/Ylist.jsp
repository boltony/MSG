...
<td colspan=4 style="padding-left:10px;text-align:left;text-indent:10px;max-width:497px;word-break:break-all">내용 : ${dto.contents}</td>
<td style="max-width:497px;"><input type="button" value="내용숨기기" id="hide${dto.seq}"/>
